...
<div class="wp-block-group bwfd-section bwfd-section--first">
	...
	<div class="wp-block-group bwfd-measure-narrow">
		<!-- wp:bwfd/section-heading {"content":"Enjoyed?","level":1,"size":"display"} -->
		<div class="wp-block-bwfd-section-heading bwfd-section-heading has-text-align-left"><h1 class="bwfd-section-heading__title has-display-font-size">Enjoyed?</h1><span class="bwfd-section-heading__rule" aria-hidden="true"></span></div>
		<!-- /wp:bwfd/section-heading -->

		<!-- wp:paragraph {"textColor":"navy","fontSize":"xxxl","fontFamily":"serif","style":{"typography":{"lineHeight":"1.35"}}} -->
		<p class="has-navy-color has-text-color has-serif-font-family has-xxxl-font-size" style="line-height:1.35">If you enjoyed <em>Biblical Wisdom for Dads</em>, there are lots of ways you can help others to find out about it &ndash; and help the author!</p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
</div>
...
<div class="wp-block-group bwfd-section bwfd-section--last" style="padding-top:52px">
	...
	<div class="wp-block-bwfd-card-grid bwfd-card-grid bwfd-card-grid--auto bwfd-card-grid--centered" style="--bwfd-grid-min:280px;--bwfd-grid-gap:22px">
		...
		<div class="wp-block-bwfd-card bwfd-card bwfd-card--accent-blue bwfd-card--marble bwfd-card--pad-regular" style="min-height:264px;gap:16px">
